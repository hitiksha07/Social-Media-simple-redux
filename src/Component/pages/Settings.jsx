...
import { editApidata } from '../../Redux/Action/Action';
    ...
    return (
        <div className="container fs-4 bg-white p-5 h-100">
            ...
            <div className="row m-4">
                <label htmlFor='fname' className="col-2 setting-lable">First Name:</label>
                <input type="text" className='col setting-inp' name='fname' value={obj.fname} onChange={getValue} />
            </div>
            <div className="row m-4">
                <label htmlFor='lname' className="col-2 setting-lable">Last Name:</label>
                <input type="text" className='col setting-inp' name='lname' value={obj.lname} onChange={getValue} />
            </div>
            <div className="row m-4">
                <label htmlFor='date' className="col-2 setting-lable">Birth-Date:</label>
                <input type="text" className='col setting-inp' name='date' value={obj.date} onChange={getValue} />
            </div>
            <div className="row m-4">
                <label htmlFor='profile' className="col-2 setting-lable">Change Profile:</label>
                <input type="file" className='col setting-inp' name='profile' onChange={getValue} />
            </div>
            <button className='m-4 btn-main w-25' onClick={saveData}>save</button>
        </div>
    )
}
