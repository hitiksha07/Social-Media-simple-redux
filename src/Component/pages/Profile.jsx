...
import { BsFillCalendarHeartFill, BsFillPersonFill } from 'react-icons/bs';
        ...
        <>
            <div className="container-fluid container-lg  bg-light h-100">
                <div className="bg-white p-4 row">
                    <div className="col-12 col-lg-4">
                        {user.profile == '' ?
                            ...
                            :
                            <img src={user.profile} alt="" height='200px' width='200px' className='shadow roun-img' />
                        }
                    </div>
                    {/* <div className=""> */}
                ...
                <div className="Profile-text p-5">
                    <div className="row">
                        <h3 className='col-12 col-md-5 fw-light fs-4'><MdAlternateEmail className='me-4'/> Email :-</h3>
                        <h2 className='col fw-normal fs-4'>{user.email}</h2>
                    </div>
                    <hr />
                    <div className="row">
                        <h3 className='col-12 col-md-5  fw-light fs-4'><BsFillPersonFill className='me-4'/> First Name :-</h3>
                        <h2 className='col fw-normal fs-4'>{user.fname}</h2>
                    </div>
                    <hr />
                    <div className="row">
                        <h3 className='col-12 col-md-5  fw-light fs-4'><BsFillPersonFill className='me-4'/> Last Name :-</h3>
                        <h2 className='col fw-normal fs-4'>{user.lname}</h2>
                    </div>
                    <hr />
                    <div className="row">
                        <h3 className='col-12 col-md-5  fw-light fs-4'><BsFillCalendarHeartFill className='me-4'/> Birth-Date :-</h3>
                        <h2 className='col fw-normal fs-4'>{user.date}</h2>
                    </div>
                    <hr />
                    <div className="m-3">
                        {/* <Link to='/account/settings' className='profile-link d-inline-block me-2 text-decoration-none btn-main w-auto mb-2 '>Edit Profile</Link> */}
