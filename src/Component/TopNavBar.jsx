...
import { addPostApiData } from '../Redux/Action/PostAction';
...
function TopNavBar() {
    ...
    return (
        <>
            <div className="col">
                <div className="top shadow p-2 d-flex justify-content-between bgc-blur-clr1">
                    ...
                    <ul className='row list-unstyled mt-3'>
                        ...
                        <li className='col d-none d-lg-block'><Link to='Profile'>
                            {user.profile == '' ?
                                ...
                                :
                                <img src={user.profile} alt="" height='50px' width='50px' className='shadow roun-img' />
                            }
                        </Link></li>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        <form action="">
                            ...
                            <div className="mb-3">
                                <button className='btn-main' type='button' onClick={savePost}>Save Post</button>
                            </div>
                        </form>
                    </Modal.Body>
                </Modal>
