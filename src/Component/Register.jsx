...
import { addApiData } from '../Redux/Action/Action';
import Swal from 'sweetalert2';


function Register() {
  let blankObj = {
    id: 0, fname: '', lname: '', email: '', password: '', profile: '', date: ''
  };
      ...
      <div className="main">
        <div className="login1 p-5">
          ...
          <div className="p-2">
            ...
            <input className="form-control inp1 mt-3" name='profile' type="file" id="formFile" onChange={getValue}></input>
          </div>
          <hr />
